...
export class DriveService {
  // private static drive: drive_v3.Drive // Use specific type
  ...
  //   DriveService.drive = google.drive({ version: "v3", auth: this.oauth2Client })
  // }
  ...
  //     const response = await DriveService.drive.files.create({
  ...
  //   }
  //   try {
  //     await DriveService.drive.files.delete({ fileId: fileId })
