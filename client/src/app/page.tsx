  ...
  const steps = [
    {
      ...
      description: 'Take the time to explore the diverse range of undergraduate and graduate programs offered at University of Port Harcourt',
      icon: GraduationCap
    },
    {
      id: '02',
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-900 to-slate-700 text-white p-6">
      ...
      <div className="w-full md:w-1/2 text-center md:text-left">
        ...
        <p className="mt-6 text-gray-700 text-base md:text-lg leading-relaxed">
          At University of Port Harcourt, we believe in the transformative power
          of education and the boundless potential within every individual.
          Established in 1975, we have been dedicated to fostering intellectual
          curiosity, academic excellence, and a vibrant campus community.
        </p>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-64 overflow-hidden">
                  ...
                  {/* Icon */}
                  <div className={`absolute top-4 right-4 w-12 h-12 rounded-full flex items-center justify-center backdrop-blur-sm transition-all duration-300
                    ${isEven 
