  ...
  return (
    <div className="container py-5">
      ...
      <div className="shadow p-4 mb-3 bg-white rounded">
        ...
        <p>
          <strong>Transaction Date:</strong> {new Date(payment.transaction_date).toLocaleString()}
        </p>
        <p>
        ...
        <p>
          <strong>Customer Email:</strong> {payment.customer.email}
        </p>
        <p>
          <strong>Bank:</strong> {payment.authorization?.bank}
        </p>
        <p>
          <strong>Card Type:</strong> {payment.authorization?.card_type}
        </p>
        <p>
          <strong>Card Brand:</strong> {payment.authorization?.brand}
        </p>
        <p>
          <strong>Card Last4:</strong> **** **** **** {payment.authorization?.last4}
        </p>
      </div>
    </div>
  )
