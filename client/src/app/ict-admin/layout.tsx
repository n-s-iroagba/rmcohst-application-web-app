        ...
        <nav className="h-full overflow-y-auto p-3 lg:p-4 flex flex-col">
          ...
          <div className="flex flex-col gap-1">
            {[
              ...
              {
                href: '/super-admin/accepted-subjects-and-grades',
                text: 'Accepted Subjects And Grades',
                icon: CheckCircle
              },
              {
                href: '/super-admin/ssc-requirements',
                text: "O'Level Requirement",
                icon: BookIcon
              },
              {
...
export default function StaffLayout({ children }: { children: React.ReactNode }) {
  return <SuperAdminOffCanvas>{children}</SuperAdminOffCanvas>
}
