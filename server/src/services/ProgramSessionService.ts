...
//    */
//   static async createSession(sessionData: CreateSessionData): Promise<AdmissionSession> {
//     const transaction: Transaction = await sequelize.transaction()

//     try {
//       // Create the new session
//       const newSession = await AdmissionSession.create(sessionData, { transaction })
...
//       const session = await AdmissionSession.findByPk(sessionId, { transaction })
...
//     const session = await AdmissionSession.findByPk(sessionId, {
//       include: [
//         {
//           model: Program,
//           as: 'programs',
...
//    */
//   static async getSessionsForProgram(programId: number): Promise<AdmissionSession[]> {
