...
const facilities = [
  ...
  },
  {
    ...
    image: sickBayImage,
    icon: SyringeIcon,
    description: 'Modern and equipped sick bay'
  },
  {
    id: 5,
    title: 'Halls',
            ...
            {steps.map((step) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-slate-400/0 via-slate-300/10 to-slate-400/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-slate-300 to-slate-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />
                </div>
              )
            })}
          </div>
                  ...
                  {facilities.map((facility, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-6 text-white bg-gradient-to-t from-slate-900/95 to-transparent transition-all duration-500">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 h-1 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left bg-gradient-to-r from-slate-400 to-slate-200" />
                        </div>
                        <div className="absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 pointer-events-none bg-slate-400" />
                      </div>
                    )
                  })}
                </div>
