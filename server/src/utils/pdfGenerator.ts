  ...
  async generateAdmissionLetter(data: AdmissionLetterData): Promise<Buffer> {
    return new Promise((resolve, reject) => {
      try {
        ...
        // Header
        doc.fontSize(20).font("Helvetica-Bold").text("ADMISSION LETTER", { align: "center" }).moveDown(2)
        ...
        // Date
        doc.text(`Date: ${new Date(data.dateOfAdmission).toLocaleDateString()}`, { align: "right" }).moveDown(1)
        ...
        doc
          ...
          .font("Helvetica")
          .text("Failure to report within the stipulated time may result in forfeiture of this admission offer.", {
            align: "justify",
          })
          .moveDown(2)
        ...
        // Closing
        doc
          .text("Once again, congratulations on your admission. We look forward to welcoming you to our institution.")
          .moveDown(2)
