...
class AdmissionSessionController {
  ...
  getAll = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      const result = await AdmissionSessionService
        .getAllSessions
        // Number(page),
        // Number(limit)
        ()
  ...
  create = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      const session = await AdmissionSessionService.createSession(req.body)

      res
        .status(201)
        .json(ApiResponseUtil.success(session, 'Academic session created successfully', 201))
    } catch (error) {
  ...
  update = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      const updatedSession = await AdmissionSessionService.updateSession(Number(id), req.body)

      res
        .status(200)
        .json(ApiResponseUtil.success(updatedSession, 'Academic session updated successfully', 200))
    } catch (error) {
  ...
  delete = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      const result = await AdmissionSessionService.deleteSession(Number(id))

      res
        .status(200)
        .json(ApiResponseUtil.success(result, 'Academic session deleted successfully', 200))
    } catch (error) {
...
export default AdmissionSessionController
